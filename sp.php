...
$sql_pro = "SELECT * FROM tbl_product,tbl_cartegory
            WHERE tbl_product.cartegory_id=tbl_cartegory.cartegory_id 
            AND tbl_product.product_name LIKE '%".$tukhoa."%'
            ";
$query_pro = mysqli_query($mysqli, $sql_pro);
?>
                ...
                <header>
                    ...
                    <nav class="nav1">
                        <ul>
                            ...
                            <li class="cart-search" style="display: flex; justify-content:center;">
                                <a href="cart.php">
                                ...
                                <a>
                                <form action="sp.php?quanly=timkiem" method="POST" autocomplete="off">
                                    <a href="#">                                       
                    ...
                    <section class="product">
                        ...
                        <form class="as_total" method="post">
                            ...
                            <ul class="products">
                                ...
                                <?php
                                // include "layouts/danhmuc.php";  //Để đây thì hiện theo danh mục chứ k hiện all
                                while ($row = mysqli_fetch_array($query_pro)) { ?>
                                    <li>
                                        <section class="product-item">
                                            <section class="product-top">
                                                <a href="" class="product-thumb">
                                                    <img src="admin/uploads/<?php echo $row['product_img'] ?>" alt="" width="100%" height="100%">
                                                </a>
                            ...
                            for($i=1; $i<=$trang; $i++){ ?>
                                ...
                                <li <?php if($i==$page){echo 'style="color:red"';}else{ echo '';} ?>>  
                                    <a href="sp.php?trang=<?php echo $i ?>">  
                                        <?php echo $i ?></a></li>
                                <!-- <li>...</li>
            ...
            <form action="">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <!-- <tr>
                        <td style="display: flex; align-items: center;"><img src="img/SP/điên2.jpg" alt=""
                                style="width: 70px">Kẻ điên bên trái</td>
                        <td>
                            <p><span>25.000</span><sup>đ</sup></p>
                        </td>
                    ...
                    <tr>
                        <td style="display: flex; align-items: center;"><img src="img/SP/điên3.jpg" alt=""
                                style="width: 70px">Kẻ điên bên trái</td>
                        <td>
                            <p><span>25.000</span><sup>đ</sup></p>
                        </td>
                ...
                <section style="text-align: right;" class="price-total">
