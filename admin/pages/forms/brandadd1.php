                            ...
                            <div class="card-body">
                                ...
                                <form class="forms-sample" method="post">
                                    <div class="form-group">
                                        <select name="cartegory_id" id="" class="form-control" id="exampleInputName1">
                                    ...
                                    <div class="form-group">
                                        <input name="brand_name" type="text" placeholder="Brand name" class="form-control" id="exampleInputName1" required>
                                    </div>
