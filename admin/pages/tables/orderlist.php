                          ...
                          <tr>
                            ...
                            <td>
                                ...
                                if ($row['cart_status'] == 1) {
                                  echo '<button class="badge badge-primary"><a href="../../class/order_class.php?cart_status=0&code=' . $row['code_cart'] . ' ">Đơn hàng mới</a></button>';
                                }else{
                                  echo "Seen";
                                }
                                ?>
                            ...
                            <td>
                              <button class="badge badge-warning"> <a href="order_details.php?&code=<?php echo $row['code_cart'] ?>">Detail</a> </button>
