                        ...
                        <div class="col-lg-6 grid-margin stretch-card">
                            <div class="card bezel">
                                <div class="card-body">
                                    ...
                                    <button class="badge badge-info"><a href="../forms/brandadd1.php" style="direction: none; color:#fff;">Add to brand</a></button>
                                            ...
                                            ?>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td><button class="badge badge-danger"> <a href="brand_delete.php?brand_id=<?php echo $result['brand_id'] ?>">Delete</a> </button>
                                                                <button class="badge badge-success"> <a href="brand_update.php?brand_id=<?php echo $result['brand_id'] ?>">Update</a></button>
                                                            </td>
                                                        </tr>
