...
if (!isset($_GET['id_user']) || $_GET['id_user']==NULL) {
    // echo "<script>window.location = 'customerlist.php' </script>";   Có tác dụng j đó nhưng mà đang viết sai cú pháp
}
else {
    $id_user = $_GET['id_user'];
}
    $get_customer = $customer -> get_customer($id_user);
    if ($get_customer) {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // $update_customer = $customer->update_customer($username, $id_user);
}
?>
              ...
              <div class="card-body">
                ...
                <form class="forms-sample" method="post">
                  <div class="form-group">
                    <label for="exampleInputName1">Category list</label>
                    <input name="cartegory_name" type="text" class="form-control" id="exampleInputName1" placeholder="Category name" value="<?php echo $result['cartegory_name']?>" required>
                  </div>
