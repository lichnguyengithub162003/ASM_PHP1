          ...
          <ul class="navbar-nav w-100">
            <li class="nav-item w-100">
              <form class="nav-link mt-2 mt-md-0 d-none d-lg-flex search" method="post">
                ...
                <button name="submit" type="submit" class="add btn btn-primary todo-list-add-btn">Search</button>
              </form>
            </li>
          </ul>
                        ...
                        $i++; ?>
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td>
                                  <!-- <button class="badge badge-danger"> <a href="product_delete.php?product_id=<?php echo $result['product_id'] ?>">Delete</a> </button> -->
                                  <!-- <button class="badge badge-success"> <a href="customer_update.php?customer_id=<?php echo $result['customer_id'] ?>">Update</a></button> -->
                              </td>
                            </tr>
