...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $update_product = $product->update_product($product_name, $cartegory_id, $brand_id, $product_price, $product_price_new, $product_desc, $product_img, $product_id);
}
?>
                            ...
                            <div class="card-body">
                                ...
                                <form class="forms-sample" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="product_name" type="text" class="form-control" id="exampleInputName1" placeholder="Product name" value="<?php echo $resultA['product_name'] ?>">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="cartegory_id" class="form-control" id="exampleInputEmail3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="brand_id" class="form-control" id="exampleInputPassword4">
                                            <option value="">-- Chọn --</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="product_price" type="text" class="form-control" id="exampleInputName1" placeholder="Product price" value="<?php echo $resultA['product_price'] ?>">
                                    </div>

                                    <!-- Giá khuyến mãi -->
                                    <div class="form-group">
                                        <label for="exampleInputName1">Product sale<span style="color: red;">*</span></label>
                                        <input name="product_price_new" type="text" class="form-control" id="exampleInputName1" placeholder="Product sale" value="<?php echo $resultA['product_price_new'] ?>">
                                    </div>

                                    <!-- Mô tả -->
                                    <div class="form-group">
                                        <label for="exampleTextarea1">Describe</label>
                                        <textarea name="product_desc" id="editor1" class="form-control" rows="5" value="<?php echo $resultA['product_desc'] ?>"></textarea>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <!-- disabled placeholder="</*?php echo $resultA['product_img'] ?>" -->

                                        <div class="input-group col-xs-12">
                                            <input type="text" class="form-control file-upload-info" placeholder="<?php echo $resultA['product_img']?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="product_img_desc[]" multiple type="file" class="file-upload-default">
