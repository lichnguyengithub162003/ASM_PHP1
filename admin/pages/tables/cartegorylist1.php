                        ...
                        <div class="col-lg-6 grid-margin stretch-card">
                            <div class="card bezel">
                                <div class="card-body">
                                    ...
                                    <button class="badge badge-info"><a href="../forms/cartegoryadd1.php" style="direction: none; color:#fff;">Add to category</a></button>
                                            ...
                                            ?>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td><button class="badge badge-danger"> <a href="cartegory_delete.php?cartegory_id=<?php echo $result['cartegory_id'] ?>">Delete</a> </button>
                                                                <button class="badge badge-success"> <a href="cartegory_update.php?cartegory_id=<?php echo $result['cartegory_id'] ?>">Update</a></button>
                                                            </td>
                                                        </tr>
