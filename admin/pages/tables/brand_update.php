...
<?php
$brand = new brand;  //Gọi hàm brand bên brand_class qua 
                            ...
                            <div class="card-body">
                                ...
                                <form class="forms-sample" method="post">
                                    ...
                                    <div class="form-group">
                                        <select name="cartegory_id" class="form-control" id="exampleInputName1">
                                            ...
                                            ?>
                                                    ...
                                                    <!-- Đổ dữ liệu từ CSDL xuống seclect -->
                                    ...
                                    <div class="form-group">
                                        <input name="brand_name" type="text" placeholder="Brand name" class="form-control" id="exampleInputName1" value="<?php echo $resultA['brand_name'] ?>">
                                    </div>
