<?php
    ...
    if(isset($_POST['thoigian'])){
        ...
        $thoigian = '';
        $subdays = Carbon::now('Asia/Ho_Chi_Minh')->subdays(365)->toDateString();   //Mặc định chạy 365 ngày
    }
    ...
    // $subdays = Carbon::now('Asia/Ho_Chi_Minh')->subdays(365)->toDateString();  //Trừ đi cái năm, chỉ hiện thứ ngày tháng
    ...
    // print_r($chart_data);
    echo $data = json_encode($chart_data);  //Trả về kiểu json
?>